...
test_matrix = grank.generate_ratings_matrix(test_dataset)  # f
...
accuracy = grank.compute_accuracy(stats, tpg, training_matrix, test_matrix, user_ids, movie_ids, k_list)
